 ...
 */
 ...
 /*
  * 04.11.2019 updated to change shifting order to R, G, B.
  */
...
/* blue, 8th bit - output & fetch next values */ \
"    sbi %[port], %[pin]  ; pin lo -> hi\n" \
"    sbrc r20, 7          ; test hi bit clear\n" \
"    rjmp 8f              ; true, skip pin hi -> lo\n" \
"    cbi %[port], %[pin]  ; false, pin hi -> lo\n" \
"8:  sbrc r20, 7          ; equalise delay of both code paths\n" \
"    rjmp 9f\n" \
